/*
cargo run -p async-stream-tls-upgrader-demo-smol --bin smtp_client smtp.gmail.com 465 xxx@gmail.com '123456'

cargo run -p async-stream-tls-upgrader-demo-smol --bin smtp_client smtp.gmail.com 587 xxx@gmail.com '123456'
*/
...
async fn run() -> io::Result<()> {
    ...
    let mut stream =
        SmtpClientInnerStream::with_imap_tcp_stream_and_tls_upgrader(tcp_stream, tls_upgrader);
